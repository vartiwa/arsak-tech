...
export const ThreePhotoSphere = () => {
  ...
  return (
    <div className="relative w-full h-full min-h-[500px] sm:min-h-[600px] lg:min-h-[700px] xl:min-h-[780px] mx-auto flex items-center justify-center select-none overflow-visible">

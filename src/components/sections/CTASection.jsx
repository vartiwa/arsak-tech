...
export const CTASection = ({ onOpenContact }) => (
  <section id="cta" className="relative py-20 md:py-32 border-t border-[rgba(22,20,14,0.08)] overflow-hidden bg-transparent">
    <div
    ...
    <div className="max-w-2xl mx-auto px-6 text-center relative">
      <Reveal>
        <span className="inline-flex items-center gap-2 text-xs font-mono tracking-wider uppercase text-[#16140E] border border-slate-300 bg-[#EAF7B8] px-3.5 py-1.5 rounded-full mb-6">
          Ready to Modernize?
        </span>
        <h2
          className="text-3xl md:text-4xl lg:text-5xl font-semibold text-[#16140E] leading-[1.15] tracking-tight"
          style={{ fontFamily: "'Space Grotesk', sans-serif" }}
        >
          Ready to automate your next enterprise process?
        </h2>
        <p className="mt-4 text-[#5C584E] text-base max-w-lg mx-auto">

...
export const WhySection = () => (
  <section id="why" className="py-16 md:py-24 border-t border-[rgba(22,20,14,0.08)] bg-transparent relative">
          ...
          <Reveal key={w.title} delay={i * 0.08}>
            <InteractiveCard accentColor={WHY_GLOWS[w.accent] || "rgba(59, 130, 246, 0.16)"} className="h-full">
              ...
              <div className="p-5 bg-[#EFECE4] border-b border-[rgba(22,20,14,0.09)] flex items-center justify-between">
                ...
                <span className="text-xs font-mono text-[#5C584E]">Pillar 0{i + 1}</span>
              </div>

              {/* BOTTOM COMPARTMENT (Body Content as per Sketch) */}
              <div className="p-6 flex-1 flex flex-col justify-between bg-white">
                <div>
                  <h3 className="text-lg font-semibold text-[#16140E] mb-2" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                    {w.title}
                  </h3>
                  <p className="text-[#5C584E] text-sm leading-relaxed">{w.desc}</p>
                </div>
                <div className="mt-5 pt-3 border-t border-[rgba(22,20,14,0.08)] text-xs font-mono text-[#5C584E]">

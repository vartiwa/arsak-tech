            ...
            <InteractiveCard accentColor="rgba(245, 158, 11, 0.14)" className="h-full">
              ...
              <div className="p-4 bg-[#EFECE3] shadow-[inset_0_2px_4px_rgba(22,20,14,0.03)] border-b border-[rgba(22,20,14,0.11)] flex flex-col gap-2.5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-mono text-[#4A453A]">Sector 0{i + 1}</span>
                </div>
              </div>
              ...
              <div className="p-5 flex-1 flex flex-col justify-between bg-white">
                <div>
                  <h3 className="text-[#0D0C09] text-base font-semibold mb-1 group-hover:text-[#0D0C09] transition-colors">
                    {ind.title}
                  </h3>
                ...
                <div className="mt-4 pt-3 border-t border-[rgba(22,20,14,0.11)] flex items-center justify-between text-xs font-mono text-[#4A453A]">
                  <span className="text-[#C0EB3A] font-medium">Enterprise Sector</span>
                  <ArrowUpRight size={13} className="text-[#756F62]" />
                </div>
              </div>
            </InteractiveCard>
          </Reveal>
          ...
          <Reveal key={ind.title} delay={i * 0.04}>
            <InteractiveCard accentColor="rgba(148, 163, 184, 0.10)" className="h-full">
              <div className="p-3.5 bg-[#EFECE3] shadow-[inset_0_2px_4px_rgba(22,20,14,0.03)] border-b border-[rgba(22,20,14,0.11)] flex items-center justify-between">
                <div className="w-7 h-7 rounded-lg flex items-center justify-center border border-slate-700 bg-slate-800/80 text-[#4A453A]">
                  <ind.icon size={14} />
                </div>
                <span className="text-[10px] font-mono text-[#4A453A]">Industry</span>
              </div>

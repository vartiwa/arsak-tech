      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 w-full">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-6 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left z-10">
            <Reveal>
              <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full border border-[rgba(22,20,14,0.12)] bg-[#EFECE3] shadow-[inset_0_2px_4px_rgba(22,20,14,0.03)] mb-3.5 text-xs font-mono text-[#10160A] font-semibold">
            ...
            <Reveal delay={0.04}>
              <h1 className="text-3xl sm:text-4xl lg:text-[50px] font-bold text-[#0D0C09] tracking-[-0.035em] leading-[1.08] max-w-xl font-['Space_Grotesk']" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                Intelligent Software & Automation Pipelines for Growing Enterprises.
              </h1>
            </Reveal>

            <Reveal delay={0.08}>
              <p className="mt-3.5 text-sm sm:text-base text-[#4A453A] leading-relaxed max-w-lg font-normal">
          ...
          {/* Right Column: Pure Clean Centerpiece 3D Earth Globe */}

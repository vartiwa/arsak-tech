...
const ManualDeskPanel = () => (
  <InteractiveCard accentColor="rgba(245, 158, 11, 0.12)" className="h-full">
    ...
    <div className="p-6 bg-white flex flex-col justify-between flex-1">
      <div>
        <h3 className="text-[#0D0C09] font-semibold text-base mb-3" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
        ...
        <div className="flex items-center gap-2.5 text-[#4A453A] text-xs sm:text-sm">
          <User size={14} className="text-amber-400 shrink-0" />
          <span>Teams re-typing data across disconnected tools</span>
        </div>
        <div className="flex items-center gap-2.5 text-[#4A453A] text-xs sm:text-sm mt-3">
              ...
              <InteractiveCard accentColor="rgba(245, 158, 11, 0.12)">
                <div className="p-4 bg-[#EFECE3] shadow-[inset_0_2px_4px_rgba(22,20,14,0.03)] border-b border-[rgba(22,20,14,0.11)] flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[#0D0C09] text-sm font-semibold">{p.title}</span>
                  </div>
                  <span className="text-xs font-mono text-[#4A453A]">0{i + 1}</span>
                </div>
                <div className="px-4 py-3 bg-white text-xs text-[#4A453A]">

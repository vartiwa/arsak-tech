...
const ManualDeskPanel = () => (
  <InteractiveCard accentColor="rgba(245, 158, 11, 0.12)" className="h-full">
    ...
    <div className="p-6 bg-[#070b16]/90 flex flex-col justify-between flex-1">
      <div>
        <h3 className="text-white font-semibold text-base mb-3" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
        ...
        <div className="grid grid-cols-6 gap-2 mb-6">
          {Array.from({ length: 18 }).map((_, i) => (
            <div
              key={i}
              className="h-3.5 rounded-sm bg-slate-900 border border-slate-800"
        ...
        <div className="flex items-center gap-2.5 text-slate-300 text-xs sm:text-sm mt-3">
          ...
          {PROBLEMS.map((p, i) => (
            <Reveal key={p.title} delay={i * 0.06}>
              <InteractiveCard accentColor="rgba(245, 158, 11, 0.12)">
                <div className="p-4 bg-[#0e1628]/70 border-b border-slate-700/60 flex items-center justify-between">
                ...
                <div className="px-4 py-3 bg-[#070b16]/90 text-xs text-slate-400">

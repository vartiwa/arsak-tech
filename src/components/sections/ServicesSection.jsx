          ...
          <Reveal key={s} delay={i * 0.05}>
            <InteractiveCard accentColor="rgba(56, 189, 248, 0.14)" className="h-full cursor-pointer" onClick={onOpenContact}>
              ...
              <div className="p-5 bg-[#0e1628]/80 border-b border-slate-700/70 flex items-center justify-between">
                ...
                <span className="text-xs font-mono text-slate-400">Service 0{i + 1}</span>
              </div>

              {/* BOTTOM COMPARTMENT (Body Content as per Sketch) */}
              <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between bg-[#070b16]/90">
                <div>
                  <h3 className="text-lg font-semibold text-white group-hover:text-cyan-200 transition-colors mb-2" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                    {s}
                  </h3>
                ...
                <div className="mt-5 pt-3 border-t border-slate-800/60 flex items-center justify-between text-xs font-mono text-slate-400">
                  ...
                  <ArrowUpRight size={13} className="text-slate-500 group-hover:text-cyan-300 transition-colors" />
                </div>
              </div>
            </InteractiveCard>
          </Reveal>

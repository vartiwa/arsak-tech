...
export const AboutSection = () => (
  <section id="about" className="py-16 md:py-24 border-t border-[rgba(239,237,226,0.08)] bg-transparent relative">
    <div className="max-w-6xl mx-auto px-6 md:px-8 grid lg:grid-cols-12 gap-10 items-center">
      <Reveal className="lg:col-span-5">
        <h2
          className="text-2xl md:text-3xl lg:text-4xl font-semibold text-[#EFEDE2] leading-[1.2] tracking-tight"
          style={{ fontFamily: "'Space Grotesk', sans-serif" }}
        >
          Technology Built Around Your Business Operations.
        </h2>
        <p className="mt-4 text-[#B7B5AA] text-sm md:text-base leading-relaxed">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          <InteractiveCard accentColor="rgba(129, 140, 248, 0.16)" className="h-full">
            ...
            <div className="p-5 sm:p-6 bg-[#070914]/95 flex-1 flex flex-col justify-between">
              ...
              <div className="mt-4 pt-3 border-t border-[rgba(239,237,226,0.08)] text-xs font-mono text-[#B7B5AA]">
                Long-term Horizon
              </div>
            </div>
          </InteractiveCard>

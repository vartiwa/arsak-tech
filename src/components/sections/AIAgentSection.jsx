...
export const AIAgentSection = () => (
  <section className="py-16 md:py-24 border-t border-[rgba(239,237,226,0.08)] bg-transparent">
    <div className="max-w-6xl mx-auto px-6 md:px-8 grid lg:grid-cols-2 gap-10 items-center">
      <Reveal>
        ...
        <h2
          className="text-2xl md:text-3xl font-semibold text-[#EFEDE2] leading-[1.2] tracking-tight"
          style={{ fontFamily: "'Space Grotesk', sans-serif" }}
        >
          An Operations Co-Pilot, Not Just a Chatbot.
        </h2>
        <p className="mt-4 text-[#B7B5AA] text-base leading-relaxed">
      ...
      <Reveal delay={0.08}>
        <div className="border border-[rgba(239,237,226,0.12)] rounded-2xl overflow-hidden bg-zinc-950/80 shadow-xl">
          <div className="flex items-center justify-between px-4 py-3 border-b border-[rgba(239,237,226,0.12)] bg-zinc-900/60">
          ...
          <div className="p-5 flex flex-col gap-3">
            ...
            <div className="self-start max-w-[90%] bg-zinc-900 border border-[rgba(239,237,226,0.12)] text-zinc-200 text-sm rounded-xl px-4 py-2.5">
              18 orders analyzed. 3 exceptions detected requiring routing:
            </div>
            <div
              className="self-start max-w-[90%] border border-[rgba(239,237,226,0.12)]/90 bg-transparent/50 rounded-xl px-4 py-3 text-xs text-[#B7B5AA] flex flex-col gap-1.5 font-mono"
            >

...
export const AIAgentSection = () => (
  <section className="py-16 md:py-24 border-t border-slate-800/60 bg-transparent">
    <div className="max-w-6xl mx-auto px-6 md:px-8 grid lg:grid-cols-2 gap-10 items-center">
      ...
      <Reveal delay={0.08}>
        <div className="border border-slate-800/80 rounded-2xl overflow-hidden bg-zinc-950/80 shadow-xl">
          <div className="flex items-center justify-between px-4 py-3 border-b border-slate-800/80 bg-zinc-900/60">
          ...
          <div className="p-5 flex flex-col gap-3">
            ...
            <div className="self-start max-w-[90%] bg-zinc-900 border border-slate-800/80 text-zinc-200 text-sm rounded-xl px-4 py-2.5">
              18 orders analyzed. 3 exceptions detected requiring routing:
            </div>
            <div
              className="self-start max-w-[90%] border border-slate-800/80/90 bg-transparent/50 rounded-xl px-4 py-3 text-xs text-zinc-300 flex flex-col gap-1.5 font-mono"
            >

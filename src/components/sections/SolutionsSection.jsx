          ...
          <Reveal key={s.title} delay={i * 0.05}>
            <InteractiveCard accentColor={ACCENT_GLOWS[s.accent] || "rgba(59, 130, 246, 0.16)"} className="h-full">
              ...
              <div className="p-5 bg-[#151815]/90 border-b border-[rgba(239,237,226,0.12)] flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5 text-xs font-mono text-[#B7B5AA] group-hover:text-[#C0EB3A] transition-colors">
              ...
              <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between bg-[#0E100F]/95">
                <div>
                  <h3
                    className="text-[#EFEDE2] font-semibold text-base mb-2 group-hover:text-[#EFEDE2] transition-colors"
